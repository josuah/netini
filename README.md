netini
======
`git://git.josuah.net/netini` - [0.4](/tool/netini/netini-0.4.tgz)

![network graph generated by netini](/tool/netini/example.png)
...
How to use it?
--------------
The [netini-dot(1)](/tool/netini/man/) tool generating the plots is reading a
